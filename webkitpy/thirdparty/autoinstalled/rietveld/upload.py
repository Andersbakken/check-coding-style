...
class VersionControlSystem(object):
  ...
  def UploadBaseFiles(self, issue, rpc_server, patch_list, patchset, options,
    ...
    def UploadFile(filename, file_id, content, is_binary, status, is_base):
      ...
      # Special case base ChangeLogs.  They are usually too big for upload,
      # and we don't care about most of the file anyway, because ChangeLogs are
      # prepend only.  Just grab the top 100 lines.
      if os.path.basename(filename) == "ChangeLog" and is_base:
        index = 0;
